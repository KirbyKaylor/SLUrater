...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>SLUrater/routes/submitcomment.js at master · KirbyKaylor/SLUrater</title>
...
<meta content="a8WhbTcEw8X7mruLriLP+k5TDyEGMGIp1p1nUgenbVTtXts9GHCF28bXMvekjg3K4Pv0IPGuSYbyFaTVEuJujA==" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-84fff2ce527238f195901d5920534eeeb2a47b8c.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="23a0e59da73e16faa8fd334ec684661d">
        ...
        <link data-pjax-transient rel='permalink' href='/KirbyKaylor/SLUrater/blob/98930a8174a0aaf759fd0dc603ec67caf83cffc9/routes/submitcomment.js'>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="2jN5LH7B7oMQNQwdDIrdwEo3v4sSDu2i+IJ7WvDlfJJtrgluoFLd89nx+bd80JQxJCuWToaXiIcxDhLD2kEvBg==" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="18110438" />
...
<!-- blob contrib key: blob_contributors:v21:c9fdf1f695c0bd70b5f87908105872b3 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/KirbyKaylor/SLUrater/blob/master/routes/submitcomment.js"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
          ...
          <form accept-charset="UTF-8" action="/KirbyKaylor/SLUrater/branches" class="js-create-branch select-menu-item select-menu-new-item-form js-navigation-item js-new-item-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="2T58yF/nj0xQ9EOVUvidi/CV0SfX3OU3ExSPeMcLks7remjUwdVOCcg6nKGyQRTwjZK00I2wF/0HfU9loEKrpQ==" /></div>
            ...
            <input type="hidden" name="path" id="path" value="routes/submitcomment.js" />
            ...
            <a class="minibutton tooltipped tooltipped-w"
               href="http://windows.github.com" aria-label="Open this file in GitHub for Windows">
                ...
                <a class="minibutton js-update-url-with-hash"
                   href="/KirbyKaylor/SLUrater/edit/master/routes/submitcomment.js"
                   data-method="post" rel="nofollow" data-hotkey="e">Edit</a>
          <a href="/KirbyKaylor/SLUrater/raw/master/routes/submitcomment.js" class="button minibutton " id="raw-url">Raw</a>
            <a href="/KirbyKaylor/SLUrater/blame/master/routes/submitcomment.js" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/KirbyKaylor/SLUrater/commits/master/routes/submitcomment.js" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->

            <a class="minibutton danger empty-icon"
               href="/KirbyKaylor/SLUrater/delete/master/routes/submitcomment.js"
...
<span id="L20" rel="#L20">20</span>
            ...
            <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="c1">// Profile page: profile or redirect</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">request</span><span class="p">,</span><span class="nx">response</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC4'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">// gets the current user, the comment message body</span></div><div class='line' id='LC5'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">user</span> <span class="o">=</span> <span class="nx">request</span><span class="p">.</span><span class="nx">session</span><span class="p">.</span><span class="nx">username</span><span class="p">;</span></div><div class='line' id='LC6'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">name</span> <span class="o">=</span> <span class="nx">request</span><span class="p">.</span><span class="nx">body</span><span class="p">.</span><span class="nx">content</span><span class="p">;</span></div><div class='line' id='LC7'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="kd">var</span> <span class="nx">route</span> <span class="o">=</span> <span class="nx">request</span><span class="p">.</span><span class="nx">body</span><span class="p">.</span><span class="nx">route</span><span class="p">;</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC9'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC10'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">if</span> <span class="p">(</span><span class="nx">username</span><span class="p">)</span> <span class="p">{</span></div><div class='line' id='LC11'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">//response.render(&#39;profile&#39;, {username:username});</span></div><div class='line' id='LC12'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC13'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">// Adds the comment to the database</span></div><div class='line' id='LC14'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c1">//comments.add(user,name,)</span></div><div class='line' id='LC15'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;</div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">else</span> <span class="p">{</span></div><div class='line' id='LC18'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="nx">response</span><span class="p">.</span><span class="nx">redirect</span><span class="p">(</span><span class="s1">&#39;/&#39;</span><span class="p">);</span></div><div class='line' id='LC19'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="p">}</span></div><div class='line' id='LC20'><span class="p">};</span></div></pre></div></td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2014 <span title="0.05755s from github-fe118-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
